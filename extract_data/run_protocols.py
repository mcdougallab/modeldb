...
automatically_curated_protocols = {
    ...
    "122442_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.load_file("DCM_0.6um_axon.ses")',
        ],
    ...
    "122442_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.load_file("TJM_0.6um_axon.ses")',
        ],
        "cleanup": ["cd ../", "rm -fr Gow_Devaux_2009"],
    },
    "37819": {
    ...
    "139657_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            "h.NetStim[0].interval=20",
            "h.myrun(h.NetStim[0].interval)",
        ],
    ...
    "144553_4": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.xopen("main_fig10_v1baseline.hoc")',
        ],  # , 'h.run()'],
        "cleanup": ["cd ../", "rm -fr V1_PFC_ModelDB"],
    },
    "144553_5": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.xopen("main_fig10_v1tuned.hoc")',
        ],  # , 'h.run()'],
        "cleanup": ["cd ../", "rm -fr V1_PFC_ModelDB"],
    },
    "144553_6": {
        ...
        "run": [
            ...
            'h.load_file("mosinit.hoc")',
            'h("doApic = 1")',
            'h.xopen("main_PFC-ApBas_fig11epsc.hoc")',
        ],  # , 'h.run()'],
        "cleanup": ["cd ../", "rm -fr V1_PFC_ModelDB"],
    },
    "144553_7": {
    ...
    "144553_8": {
        ...
        "run": [
            ...
            'h.load_file("mosinit.hoc")',
            'h("doSynType = 0")',
            'h.xopen("main_V1-ApBas_fig11epsc.hoc")',
        ],  # , 'h.run()'],
        "cleanup": ["cd ../", "rm -fr V1_PFC_ModelDB"],
    },
    "144553_9": {
    ...
    "144553_12": {
        ...
        "run": [
            ...
            'h.load_file("mosinit.hoc")',
            'h("doApic = 1")',
            'h.xopen("main_PFC-ApBas_fig12ipsc.hoc")',
        ],  # , 'h.run()'],
        "cleanup": ["cd ../", "rm -fr V1_PFC_ModelDB"],
    },
    "144553_13": {
    ...
    "144553_14": {
        ...
        "run": [
            ...
            'h.load_file("mosinit.hoc")',
            'h("doSynType = 0")',
            'h.xopen("main_V1-ApBas_fig12ipsc.hoc")',
        ],  # , 'h.run()'],
        "cleanup": ["cd ../", "rm -fr V1_PFC_ModelDB"],
    },
    "144553_15": {
    ...
    "144482": {
        "variant": "Run",
        "compile": [
            "cd Pyramidal_STDP_Gomez_Delgado_2010",
            "nrnivmodl mechanism/mechanism_cell1/",
        ],
        "launch": ["python"],
        "run": ["from neuron import h, gui", 'h.load_file("mosinit.hoc")', "h.run()"],
    ...
    "87454": {
        "compile": [
            "cd BahmerLangner2007/NEURON_Chopper_Network_Simulation",
            "nrnivmodl",
        ],
        "launch": ["python"],
        "run": [
    ...
    "145672_4": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.load_file("Figure11C CSIOSI.hoc")',
            "h.runu()",
        ],
        "cleanup": ["cd ../", "rm -fr Fineberg_et_al_2012"],
    },
    ...
    "136310": {
        ...
        "run": [
            ...
            "h.runfft()",
            "h.draw_fft()",
            "h.calc_extracellular()",
            "h.draw_extracellular()",
        ],
    ...
    "135787_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.load_file("best_full_axon_spike_init.hoc")',
            "h.run()",
        ],
    ...
    "135787_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.load_file("best_full_axon_decay.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr ShuEtAl20062007"],
    },
    ...
    "139654_5": {
        ...
        "run": [
            ...
            'h("cell_nr = 7")',
            "h.restart()",
            'h.load_file(1, "traincontrol.hoc")',
        ],
        "cleanup": ["cd ../", "rm -fr 2VN"],
    },
    "139654_6": {
    ...
    "140299_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.loadModel("BE17B_length_adjusted_NoActive.hoc")',
            "h.run()",
        ],
    ...
    "140299_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.loadModel("BE59D_length_adjusted_NoActive.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr KubotaEtAl2011"],
    },
    "140299_3": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.loadModel("BE77C_length_adjusted_NoActive.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr KubotaEtAl2011"],
    },
    "140299_4": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.loadModel("LV38E_length_adjusted_NoActive.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr KubotaEtAl2011"],
    },
    ...
    "118662_4": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h("restart_(\\"figure_4b_dendrite1\\")")',
        ],
        "cleanup": ["cd ../", "rm -fr dm1_pn_model"],
    },
    "118662_5": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h("restart_(\\"figure_4b_dendrite2\\")")',
        ],
        "cleanup": ["cd ../", "rm -fr dm1_pn_model"],
    },
    "118662_6": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h("restart_(\\"figure_4b_dendrite3\\")")',
        ],
        "cleanup": ["cd ../", "rm -fr dm1_pn_model"],
    },
    "51022": {
...
manually_curated_protocols = {
    ...
    "152028_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-in-all.ses")',
            "h.run()",
        ],
    ...
    "152028_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-70um.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_3": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-70um-tomasz.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_4": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-70um-onlyNa.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_5": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-70um-mimic-synapses.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_6": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-70um-mimic-synapses-v-change.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_7": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-70um-mimic-synapses-sustained-currents.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_8": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-70um-10x-mimic-sustained.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_9": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-70um-10x-mimic-sustained-random.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_10": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-70um-10alphasynapses.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_11": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-ext-axon-50um-onlyNa.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_12": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-botdend.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_13": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-axon.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_14": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2-chans-axon-last.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "152028_15": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("exp-axon-tail2.ses")',
            "h.run()",
        ],
        "cellviews": [[[0, 0, 100, 100], [20, -20, 80, 40], [0, -50, 100, 50]]],
        "cleanup": ["cd ../../", "rm -fr Gunay_etal_2014"],
    ...
    "151482_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.xopen("hoc_code/Model_fit_code/I-V.hoc")',
        ],
    ...
    "151482_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.xopen("hoc_code/Model_fit_code/I-F.hoc")',
        ],
        "cleanup": ["cd ../", "rm -fr SPN_ModelDB"],
    },
    "151731": {
    ...
    "168414_1": {
        "variant": "WindUp",
        "compile": [
            "cd ZhangEtAl2014/WindUp",
            r"cp ../Critical\ Mod\ Files/*.mod .",
            "nrnivmodl",
        ],
        "launch": ["python"],
    ...
    "168414_2": {
        "variant": "Fiber, No EP",
        "compile": [
            r'cd "ZhangEtAl2014/A Fiber Inhibition"',
            r"cp ../Critical\ Mod\ Files/*.mod .",
            "nrnivmodl",
        ],
        "launch": ["python"],
    ...
    "168414_3": {
        "variant": "Foreman SCS",
        "compile": [
            r'cd "ZhangEtAl2014/Foreman SCS"',
            r"cp ../Critical\ Mod\ Files/*.mod .",
            "nrnivmodl",
        ],
        "launch": ["python"],
    ...
    "150446_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit_16PC_1IN.hoc")',
            "h.run()",
        ],
    ...
    "150446_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit_1PC_1IN.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr VladimirovTuTraub2013"],
    },
    "150446_3": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit_1PC_1INmyelinatedAx.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr VladimirovTuTraub2013"],
    },
    "150446_4": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit_1PC_1INsilent2firing.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr VladimirovTuTraub2013"],
    },
    "150446_5": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit_81PC_9INforward.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr VladimirovTuTraub2013"],
    },
    ...
    "64228_6": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.restart("Fig9_AP_Patterns.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr Liu-Kourennyi_2004"],
    },
    ...
    "150024_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("DCN_spontact_loop_main.hoc")',
        ],
    ...
    "136026_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.load_file("init_spiketuft.hoc")',
            "h.setparams(h.BOTHCONTROL)",
            "h.doit()",
        ],
    ...
    "113997_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("demo_HPGA_non-saturating.hoc")',
            "h.run()",
        ],
    ...
    "113997_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("demo_HPGA_non-saturating_noIh.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr HAGPA"],
    },
    "113997_3": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("demo_HPGA_saturating.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ../", "rm -fr HAGPA"],
    },
    ...
    "18197_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.restart("demo_glutamate_neuralcomputation")',
        ],
    ...
    "18197_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.restart("demo_gaba_neuralcomputation")',
        ],
        "cleanup": ["cd ../", "rm -fr Neural_Computation"],
    },
    "143114_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("LSO_synaptic_input.hoc")',
            "h.rerun()",
        ],
    ...
    "143114_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("LSO_current_input.hoc")',
            "h.rerun()",
        ],
        "cleanup": ["cd ../", "rm -fr ZhouColburn2010"],
    },
    ...
    "20212_1": {
        ...
        "compile": [
            "cd CA1_multi/experiment/cluster-dispersion",
            "nrnivmodl ../../mechanism",
            "chmod +x newshiftsyn",
            "export PATH=.:$PATH",
        ],
    ...
    "116096_1": {
        ...
        "run": [
            ...
            'h.load_file("mosinit.hoc")',
            "h.ampasyn.delta = -100",
            "h.set_axis_limits(0.0014, 0.007, 0.7, 0.014)",
            "h.run()",
        ],
    ...
    "116096_2": {
        ...
        "run": [
            ...
            'h.load_file("mosinit.hoc")',
            "h.ampasyn.delta = -10",
            "h.set_axis_limits(0.0014, 0.007, 0.7, 0.35)",
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr badoual_stdp"],
    },
    "116096_3": {
        ...
        "run": [
            ...
            'h.load_file("mosinit.hoc")',
            "h.ampasyn.delta = 10",
            "h.set_axis_limits(0.0045, 0.5, 0.9, 0.014)",
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr badoual_stdp"],
    },
    "116096_4": {
        ...
        "run": [
            ...
            "h.ampasyn.delta = 200",
            "h.ampasyn.onset = 10",
            "h.set_axis_limits(0.0016, 0.016, 0.7, 0.014)",
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr badoual_stdp"],
    },
    ...
    "136715_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.load_file("Fig4B 10APs ver7a.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr FleidervishEtAl2010"],
    },
    "136715_3": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.load_file("Fig4B 100APs ver7a.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr FleidervishEtAl2010"],
    },
    ...
    "123897_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.xopen("experiment/Pyramidal_Main.hoc")',
            "h.freePlay()",
            "h.run()",
        ],
    ...
    "123897_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.xopen("experiment/UniformAxon_Main.hoc")',
        ],
        "cleanup": ["cd ..", "rm -fr HuEtAl2009"],
    },
    "123897_3": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit.hoc")',
            'h.xopen("experiment/SingleComp_Main.hoc")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr HuEtAl2009"],
    },
    ...
    "54903_1": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-hh-dark grey_bar.ses")',
            "h.run()",
        ],
    ...
    "54903_2": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-hh-light grey_bar.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    "54903_3": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-NaCh-black_bar.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    "54903_4": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-NaCh-dark grey_bar.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    "54903_5": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-NaCh-light grey_bar.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    "54903_6": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-naf-black_bar.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    "54903_7": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-naf-dark grey_bar.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    "54903_8": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-naf-light grey_bar.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    "54903_9": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-naxn-black.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    "54903_10": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-naxn-dark grey_bar.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    "54903_11": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("Fig7C-naxn-light grey_bar.ses")',
            "h.run()",
        ],
        "cleanup": ["cd ..", "rm -fr Hossain"],
    },
    ...
    "126637_2c": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit_spine and spine neck at spinydendrite133.hoc")',
        ],
    ...
    "126637_2d": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit_reduced_PPR model.hoc")',
        ],
        "cleanup": ["cd ..", "rm -fr purkinje_ppr"],
    },
    "126637_cvode": {
        ...
        "run": [
            "from neuron import h, gui",
            'h.load_file("mosinit_reduced_PPR model_cvode.hoc")',
        ],
        "cleanup": ["cd ..", "rm -fr purkinje_ppr"],
    },
    "146026_ex1": {
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        with open(
            os.path.join(
                "/home/morse/senselab/Web/ModelDB/jsondata", "modelview_duplicates.txt"
            ),
            "w",
        ) as f:
